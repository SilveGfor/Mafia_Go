...
public class RulesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        models.add(new RuleModel(R.drawable.mafiago, "Ход игры:", "Каждый игрок может отправить не более 10 сообщений днем. Если игрокам уже нечего обсуждать, они могут нажать на кнопку пропуска дня. Если на нее нажмут 80 и более процентов живых игроков, то день пропустится. Мирные жители, которые обладают дневными способностями, могут выбрать свою цель. Во время второй фазы наступает голосование, где жители могут проголосовать за того, кого хотят убить. В это время террорист может попытаться взорвать свою цель.\n" +
                "\n" +
