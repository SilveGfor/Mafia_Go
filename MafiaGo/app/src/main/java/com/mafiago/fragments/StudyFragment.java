...
public class StudyFragment extends Fragment implements OnBackPressedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TV_roomName = view.findViewById(R.id.fragmentStudy_TV_roomName);
        ...
        {
            case "mafia":
                list_chat.add(new MessageModel(0, "Приветствую тебя, ты попал на ускоренные курсы по подготовке юных мафиози! Я один из разработчиков Mafia Go и сейчас расскажу тебе основы. Нажми \"Далее\" для продолжения", "19-00", dev, "UsersMes", "alive", "разработчик", null, ""));
                messageAdapter.notifyDataSetChanged();
                TV_continue.setOnClickListener(v -> {
                    switch (continue_num)
                    {
                        case 0:
                            list_chat.add(new MessageModel(0, "Сейчас ты пройдёшь обучение за роль \"Мафия\". Также в настройках можно пройти обучение за другие роли - можешь потом попробовать", "19-00", dev, "UsersMes", "alive", "разработчик", null, ""));
                            messageAdapter.notifyDataSetChanged();
                            continue_num++;
                            break;
                        case 1:
                            list_chat.add(new MessageModel(0, "В игре есть 5 фаз: лобби, 1 фаза ночи, 2 фаза ночи, день и голосование. В фазе 'лобби' игроки собираются в комнате и ждут начала игры. Как только зайдёт минимальное количество человек для данной комнаты, пойдёт обратный отсчёт до начала игры", "19-00", dev, "UsersMes", "alive", "разработчик", null, ""));
                            messageAdapter.notifyDataSetChanged();
                            continue_num++;
                        ...
                        case 2:
                            ...
                            list_chat.add(new MessageModel(0, "Сразу после начала игры начинается 1 фаза ночи. Во время первой фазы ночи ходят любовница и доктор лёгкого поведения, мафия и дон мафии общаются в ночном чате, который видно только им, а остальные жители города мирно спят", "19-00", dev, "UsersMes", "alive", "разработчик", null, ""));
                        ...
                        case 3:
                            ...
                            new TapTargetSequence(getActivity())
                                    .targets(
                                            TapTarget.forView(TV_roomName,"Кстати, если ты нажмёшь на название комнаты, то увидишь список всех ролей и их количество в этой комнате","")
                                                    ...
                                                    .targetRadius(80)).listener(new TapTargetSequence.Listener() {
                                @Override
                                public void onSequenceFinish() {
                                    list_roles.add(new RoleModel(Role.CITIZEN, 1));
                                    list_roles.add(new RoleModel(Role.DOCTOR, 1));
                                    list_roles.add(new RoleModel(Role.SHERIFF, 1));
                                    list_roles.add(new RoleModel(Role.LOVER, 1));
                                    list_roles.add(new RoleModel(Role.MAFIA, 1));
                                    list_roles.add(new RoleModel(Role.MAFIA_DON, 1));
                            ...
                            break;
                        case 4:
                            list_chat.add(new MessageModel(0, "Нажми на мигающий пистолет", "19-00", dev, "UsersMes", "alive", "разработчик", null, ""));
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            list_chat.add(new MessageModel(0, "Шериф не угадал мафию, поэтому победа у нас в кармане! Если [Игрок 1] - шериф, то [Игрок 3] - любовница. Любовница сейчас для нас опаснее шерифа, поэтому надо бить её", "19-00", dev, "UsersMes", "alive", "разработчик", null, ""));
                            ...
                            break;
                        case 11:
                            list_chat.add(new MessageModel(0, "Если у тебя появился значок сердечка, то на тебя походила любовница. Из-за этого ты не можешь голосовать этой ночью и днём", "19-00", dev, "UsersMes", "alive", "разработчик", null, ""));
                        ...
                        case 12:
                            list_chat.add(new MessageModel(0, "Мафия выходит искать своих жертв, а часть мирного населения идет противостоять мафии!", "19-00", "Server", "SystemMes"));
                            list_chat.add(new MessageModel(0, "Значок звёздочки означает, что тебя проверил шериф и теперь он знает твою роль", "19-00", dev, "UsersMes", "alive", "разработчик", null, ""));
                        ...
                        case 13:
                            ...
                            list_chat.add(new MessageModel(0, "Сейчас голосовать могу только я и шериф, у нас будет дуэль. Надеюсь я выиграю. Если он меня победит, то отомсти за меня ночью! А теперь нажми на кнопку \"пропустить день\"", "19-00", dev, "UsersMes", "alive", "разработчик", null, ""));
                        ...
                        case 18:
                            ...
                            TV_title.setText("Победа!");
                            TV_text.setText("Мафия победила в этой игре! Теперь я могу закончить экскурсию по приложению");
                            ...
                            messageAdapter.notifyDataSetChanged();
                            continue_num++;
                            TV_continue.setText("Продолжить");
