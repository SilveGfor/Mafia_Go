...
public class GameFragmentLate extends Fragment implements OnBackPressedListener {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        ViewPager viewPager = view.findViewById(R.id.fragmentGame_VP_chat);
        //viewPager.setAdapter(new GameChatPagerAdapter(getActivity().getSupportFragmentManager(), getActivity(), 2));
