...
public class RulesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        models.add(new RuleModel(R.drawable.ic_snow, "Мафия", "Мафия - главный персонаж, именно мафия решает, кого она убьёт ночью. Чтобы выиграть, команде мирных нужно истребить всю мафию!"));
        ...
        models.add(new RuleModel(R.drawable.icon_doctor, "Доктор", "Доктор - наш спаситель. Перед рассветом может исцелить любого игрока. Даже если кого-то ночью хотели убить, доктор может его спасти"));
        models.add(new RuleModel(R.drawable.icon_mir, "Городской житель", "Обычный игрок, у него нет каких-либо специальных возможностей. Днём пытается вместе со всеми найти мафию"));
